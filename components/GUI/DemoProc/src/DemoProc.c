...
HMI_SCREEN_OBJECT *g_arrpstScreenObjs[] = {
    ...
    &g_stHMIDemo_VariableBox, &g_stHMIDemo_RealtimeGraph,
    &g_stHMIDemo_Menu,        &g_stHMIDemo_Notice,
    &g_stHMIDemo_BasicPaint,  &g_stHMIDemo_Curve,
...
{
    ssd1306_set_pixel(iX, iY, iColor);
}
#ifdef SGUI_GET_POINT_FUNC_EN
SGUI_INT SSD1306GetPixel(SGUI_INT iPage, SGUI_INT iColumn)
{
    return ssd1306_get_pixel(iX, iY);
}
...
HMI_ENGINE_RESULT InitializeHMIEngineObj(void)
{
    ...
    #ifdef SGUI_GET_POINT_FUNC_EN
    g_stDeviceInterface.fnGetPixel = SSD;
    #endif // SGUI_GET_POINT_FUNC_EN
    g_stDeviceInterface.fnFillRect = NULL;
    g_stDeviceInterface.fnClear = NULL;
    g_stDeviceInterface.fnSyncBuffer = NULL;
#endif
    ...
    do
    {
        ...
        eProcessResult =
            HMI_ActiveEngine(&g_stDemoEngine, HMI_SCREEN_ID_DEMO_LIST);
