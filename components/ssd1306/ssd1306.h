...
extern "C"
{
    ...
    void ssd1306_display_text(SSD1306_t *dev, int page, char *text,
                              int text_len, bool invert);
    void ssd1306_display_text_x3(SSD1306_t *dev, int page, char *text,
                                 int text_len, bool invert);
    ...
    uint8_t ssd1306_copy_bit(uint8_t src, int srcBits, uint8_t dst,
                             int dstBits);
