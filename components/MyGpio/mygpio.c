...
tGpioConf gGpioConf[] = {
    ...
    {"HX711DT", GPIO_E_HX711_DT, 0, MY_GPIO_LOW, GPIO_MODE_INPUT, GPIO_INTR_DISABLE},
    {"HX711SCK", GPIO_E_HX711_SCK, 0, MY_GPIO_LOW, GPIO_MODE_OUTPUT, GPIO_INTR_DISABLE},
#endif
#ifdef CONFIG_PUMP_EN
    {"PumpEn", GPIO_E_PUMP_EN, 0, MY_GPIO_LOW, GPIO_MODE_INPUT_OUTPUT, GPIO_INTR_DISABLE, GPIO_PULLUP_ENABLE, GPIO_PULLDOWN_DISABLE},
#endif
#ifdef CONFIG_ESP32_C3_LED_ENABLE
    {"LedD4", GPIO_E_LED_D4, 0, MY_GPIO_LOW, GPIO_MODE_OUTPUT, GPIO_INTR_DISABLE, GPIO_PULLUP_ENABLE, GPIO_PULLDOWN_DISABLE},
    {"LedD5", GPIO_E_LED_D5, 0, MY_GPIO_LOW, GPIO_MODE_OUTPUT, GPIO_INTR_DISABLE, GPIO_PULLUP_ENABLE, GPIO_PULLDOWN_DISABLE},
#endif
...
void GpioInit()
{
    ...
    for (i = 0; i < gGpioConfSize; i++)
    {
        ...
        gpio_config(&ioConfig);
        if((ioConfig.mode == GPIO_MODE_INPUT_OUTPUT) || (ioConfig.mode == GPIO_MODE_OUTPUT))
        {
